...
int main(void) {
    ...
    size_t i_src = 20, j_src = 35, k_src = 35;
    size_t i_probe = 30;
    size_t i_interface = 40;
    ...
    if (materials_set_box(mat, g_mat, i_interface, N + 1, 0, N + 1, 0, N + 1,
                           eps_r, sigma) != 0) {
    ...
    if (!diff) { fprintf(stderr, "malloc failure\n"); return 1; }
    ...
    size_t incident_start = 40, incident_end = 75;
    size_t reflect_start = 76, reflect_end = 140;
